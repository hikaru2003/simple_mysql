...
for i in range(params.nodeCount):
    ...
    node.addService(pg.Execute(shell="bash", command="wget -O /local/setup.sh https://raw.githubusercontent.com/hikaru2003/simple_mysql/refs/heads/main/setup_server.sh"))
